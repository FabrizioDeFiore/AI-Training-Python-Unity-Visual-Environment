...
{ 
    ...
    public TMP_Text CHPTemp1SP_PredText;
    ...
    void Start(){
        if (objectToUpdate1 == null || objectToUpdate2 == null || objectToUpdate3 == null || objectToUpdate4 == null ){
                                ...
                                if (line.Trim() != ""){ // Ignore empty lines
                                    ...
                                    if (dataParts.Length >= 2){
                                        ...
                                        if (float.TryParse(dataParts[1], out dataPoint)){
                                            ...
                                            }else if (dataStreamName == "CHPTemp1SP_Pred"){
                                                CHP1SPredQueue.Enqueue(dataPoint);
                                            }else{
    ...
    void Update(){
        ...
        if (chpTemp1Queue.Count > 0){
            ...
            chpTemp1Text.text = data.ToString("F2")+ (" °C");
        ...
        if (loopTemp1Queue.Count > 0){
            ...
            loopTemp1Text.text = data.ToString("F2")+ (" °C");
        ...
        if (stoomQueue.Count > 0){
            ...
            stoomText.text = (data * 1000).ToString("F2")+ (" Kg/h"); 
        ...
        if(CHP1SPredQueue.Count > 0){
            ...
            float normalizedData_yScale = data / 100f ;  
            float yPosition = CalculateYPosition(normalizedData_yScale);
            UpdateObject(objectToUpdate4, normalizedData_yScale, yPosition);
            CHPTemp1SP_PredText.text = data.ToString("F2") + (" °C"); 
            //stoomText.text = normalizedData_yScale.ToString("F4");
        }
    }
}
